...
public interface DetailCollectionRepository extends JpaRepository<DetailCollection , Integer> {
    ...
    public List<DetailCollection> findDetailCollectionByCollectionId(int collectionId);


    public DetailCollection findAllByCollectionIdAndCourseId(int collectionId,int courseId);
}
